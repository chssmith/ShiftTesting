...
abstract class SectionController extends Controller
{
     ...
     **/
    abstract public function show(Students $student, User $vpb_user, CompletedSections $completed_sections);
     ...
     **/
    abstract public function store(Request $request, Students $student, CompletedSections $completed_sections);
     ...
     **/
    abstract public function getMissingInformation(Students $student);
}
